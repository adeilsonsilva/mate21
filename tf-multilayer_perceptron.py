...
PLOT_DATA_OUTPUT = "tf-multilayer_perceptron.csv"
MODEL_FILENAME = "./tf-multilayer_perceptron.model"
OUTPUT_FILENAME = "tf-multilayer_perceptron.output"
...
def create_tf_graph():
    ...
    with graph.as_default():
    	...
    	out = tf.layers.dense(fc, common_data.N_CLASS, activation=tf.nn.sigmoid)
